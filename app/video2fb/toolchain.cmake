...
if(DEFINED ENV{TOOLCHAIN_PATH} AND NOT "$ENV{TOOLCHAIN_PATH}" STREQUAL "")
    ...
    set(TOOLCHAIN_PATH "${WORKSPACE_ROOT}/tools/linux/toolchain/arm-rockchip830-linux-uclibcgnueabihf")
endif()

if(NOT EXISTS "${TOOLCHAIN_PATH}/bin")
    message(FATAL_ERROR "Toolchain path not found: ${TOOLCHAIN_PATH}. You can set env TOOLCHAIN_PATH to override.")
endif()
